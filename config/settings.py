...
SECRET_KEY = 'django-insecure-sca!2--a2pf&r!5qj(^l#^0it5^t1f#q-j$3+#z3w=!v_r8jja'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'globalHub.context_processors.add_variable_to_context',
            ],
        },
    },
]
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "GlobalHub admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "GlobalHub",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "GlobalHub",
    ...
    "welcome_sign": "Welcome to the GlobalHub admin-site",
